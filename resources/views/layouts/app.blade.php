...
<head>
	...
	<link rel="stylesheet" href="{{ asset('backend/assets/css/additionalStyle.css') }}">
...
<body class="sb-nav-fixed">
	...
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand text-md-center" href="{{ route('dashboard.index') }}">{{ get_option('site_title',
				config('app.name')) }}</a>
			...
			<ul class="navbar-nav ml-auto ml-md-0 notification-area">
				<li class="nav-item dropdown animate-dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right bell-notify-box notify-box">
						@if($notificatioCount > 0)
						<span class="notify-title">{{ _lang('You have').' '.$notificatioCount.' '._lang('new
							notifications') }}</span>
						@else
						...
						<div class="nofity-list">
							...
							<div class="d-flex notify-item">
								<a href="{{ route('profile.show_notification', $notification->id) }}" class="ajax-modal"
									data-title="{{ _lang('Notification') }}">
									<div class="notify-text">
										<p class="{{ $notification->read_at == null ? 'unread-notification' : '' }}">{{
			...
			<ul class="navbar-nav ml-auto ml-md-0">
				<li class="nav-item dropdown animate-dropdown">
					<a class="nav-link dropdown-toggle" id="languageSelector" href="#" role="button"
						data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icofont-world"></i>
			...
			<ul class="navbar-nav ml-auto ml-md-0">
				<li class="nav-item dropdown animate-dropdown">
					<a class="nav-link dropdown-toggle" id="userDropdown" href="#" role="button" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false"><i class="icofont-ui-user"></i></a>
