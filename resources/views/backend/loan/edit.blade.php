					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="loan_id" value="{{ $loan->loan_id }}" disabled required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control float-field" id="cash-out" name="cash_out" value="{{$loan->cash_out}}" required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">{{ _lang('Payment Methods') }}</label>
								<select class="form-control auto-select" data-selected="{{ $loan->withdraw_method_id}}" name="withdraw_method_id" {{ $loan->status == 1 ? 'disabled' : 'required' }}>
									<option value="">{{ _lang('Select One') }}</option>
									{{ create_option('withdraw_methods','id','name','',array('status=' => 1)) }}
								</select>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control float-field" name="admin_fee" value="{{$loan->admin_fee}}" disabled required>
							</div>
						</div>
