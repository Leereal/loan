					...
					<div class="row">	
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control float-field" id="cash-out" name="cash_out" value="{{ old('cash_out') }}" required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control float-field" id="applied-amount" name="applied_amount" value="{{ old('applied_amount') }}" required>
							</div>
						</div>
