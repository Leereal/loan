	...
	<div class="col-lg-8 offset-lg-2">
		<div class="card">
			...
			<div class="card-body">
				...
				<form action="{{ route('profile.update') }}" autocomplete="off"
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<select class="form-control select2 auto-select"
									data-selected="{{ $profile->country_code }}" name="country_code" required>
						...
						<div class="col-12">
							<div class="form-group">
								...
								<input type="file" class="form-control dropify"
									data-default-file="{{ $profile->profile_picture != '' ? ('uploads/profile/'.$profile->profile_picture) : '' }}"
						...
						<div class="col-12">
							<div class="form-group">
								<button type="submit" class="btn btn-primary btn-block"><i
										class="icofont-check-circled"></i> {{ _lang('Update Profile') }}</button>
							</div>
						</div>
					</div>
				</form>
