	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header d-flex align-items-center">
				...
				<a class="btn btn-primary btn-sm ml-auto ajax-modal" data-title="{{ _lang('Create Role') }}"
					href="{{ route('roles.create') }}"><i class="icofont-plus-circle"></i> {{ _lang('Add New') }}</a>
			</div>
			<div class="card-body">
				<table id="roles_table" class="table table-bordered data-table">
					...
					<tbody>
						...
						<tr data-id="row_{{ $role->id }}">
							...
							<td class="multiple_branch">{{ allowStatus($role->multiple_branch) }}</td>
