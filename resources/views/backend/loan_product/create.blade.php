					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control float-field" name="admin_fee" value="{{ old('admin_fee') }}">
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control float-field" name="penalty_fee" value="{{ old('penalty_fee') }}">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="number" class="form-control" name="ceil_factor" value="{{ old('ceil_factor') }}">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
