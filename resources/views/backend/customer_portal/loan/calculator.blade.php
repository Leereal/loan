					...
					<div class="row">						
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" class="form-control float-field" id="apply-amount" name="apply_amount" value="{{ old('apply_amount',$apply_amount) }}" required>
							</div>
						</div>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" class="form-control float-field" id="cash-out" name="cash_out" value="{{ old('cash_out',$cash_out) }}" required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control float-field" id="admin-fee" name="admin_fee" value="{{ old('admin_fee',$admin_fee) }}" required>
									<div class="input-group-append">
										<span class="input-group-text">%</span>
									</div>
								</div>
