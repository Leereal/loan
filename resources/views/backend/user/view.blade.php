                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active mt-4" id="employment_details">
                                <div class="card">
                                    ...
                                    <div class="card-footer">
                                        <a href="{{action('EmploymentDetailController@edit',$employment_detail->id)}}"><button type="button" class="btn btn-secondary">Edit</button></a>
                                        <form method="post" action="{{action('EmploymentDetailController@destroy',$employment_detail->id)}}">
                                            {{ csrf_field() }}
                                            <input type="hidden" value="DELETE" name="_method">
                                            <button type="submit" class="btn btn-danger float-right"><i class="mdi mdi-delete"></i>Delete</button></a>
                                        </form>
                                    </div>
                                    @endif
                                </div>                                
                            ...
                            <div class="tab-pane fade" id="next_of_kin_details">
                                <div class="card">
                                    ...
                                    @if(!empty($next_of_kin)) 
                                        ...
                                        <div class="card-footer">
                                        <a href="{{action('NextOfKinController@edit',$next_of_kin->id)}}"><button type="button" class="btn btn-secondary float-left"><i class="mdi mdi-pencil"></i>Edit</button></a>
                                        <form method="post" action="{{action('NextOfKinController@destroy',$next_of_kin->id)}}">
                                            {{ csrf_field() }}
                                            <input type="hidden" value="DELETE" name="_method">
                                            <button type="submit" class="btn btn-danger float-right"><i class="mdi mdi-delete"></i>Delete</button></a>
                                        </form>
                            ...
                            <div class="tab-pane mt-4" id="guarantor_details">
                                <div class="card">
                                    ...
                                    @if(!empty($guarantor)) 
                                        ...
                                        <div class="card-footer">
                                        <a href="{{action('GuarantorController@edit',$guarantor->id)}}"><button type="button" class="btn btn-secondary float-left"><i class="mdi mdi-pencil"></i>Edit</button></a>
                                        <form method="post" action="{{action('GuarantorController@destroy',$guarantor->id)}}">
                                            {{ csrf_field() }}
                                            <input type="hidden" value="DELETE" name="_method">
                                            <button type="submit" class="btn btn-danger float-right"><i class="mdi mdi-delete"></i>Delete</button></a>
                                        </form>
