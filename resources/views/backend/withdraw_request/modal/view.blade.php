<table class="table table-bordered">
    ...
    @if(!empty($withdrawRequest->requirements))
    ...
    <tr>
        ...
        <td>
            {!! $withdrawRequest->attachment == "" ? '' : '<a href="'. url('uploads/media/'.$withdrawRequest->attachment) .'" target="_blank">'._lang('View Attachment').'</a>' !!}
        </td>
    </tr>
