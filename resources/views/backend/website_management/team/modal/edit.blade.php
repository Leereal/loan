    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="file" class="form-control dropify" name="image"  data-default-file="{{ $team->image != '' ? url('uploads/media/'.$team->image) : '' }}">
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="role" value="{{ $team->role }}"  data-default-file="{{ $team->image != '' ? url('uploads/media/'.$team->image) : '' }}">
            </div>
        </div>
